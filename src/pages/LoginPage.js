...
export default function LoginPage() {
  ...
  return (
    <>
      <Helmet>
        <title> Login | AgroProductos </title>
      </Helmet>
      ...
      >
        ...
        >
          {mdUp && (
            <Box sx={{ mr: 4, height: '100%', flex: 1 }}>
              <svg xmlns="http://www.w3.org/2000/svg" data-name="Layer 1" viewBox="0 0 869.99994 520.13854">
                <path
          ...
          <Box sx={{ flex: 1 }}>
            ...
            <Typography
              variant="h4"
              gutterBottom
              sx={{ mb: 2, display: 'flex', justifyContent: 'center', textAlign: 'center' }}
            >
              Login a AgroProductos
            </Typography>
